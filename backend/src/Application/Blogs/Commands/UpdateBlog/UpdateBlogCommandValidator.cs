...
public class UpdateBlogCommandValidator : AbstractValidator<UpdateBlogCommand>
{
    ...
    public UpdateBlogCommandValidator(IApplicationDbContext context)
    {
        _context = context;
    ...
    public async Task<bool> BeUniqueSlug(UpdateBlogCommand request, string slug, CancellationToken cancellationToken)
    {
        return !await _context.Blogs
            .AnyAsync(b => b.Slug == slug && b.Id != request.Id, cancellationToken);
    }
