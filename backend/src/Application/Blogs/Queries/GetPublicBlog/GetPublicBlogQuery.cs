...
namespace MyApp.Application.Blogs.Queries.GetPublicBlog;

public record GetPublicBlogQuery : IRequest<PublicBlogDto?>
{
    public int? Id { get; init; }
    public string? Slug { get; init; }
}

public class GetPublicBlogQueryHandler : IRequestHandler<GetPublicBlogQuery, PublicBlogDto?>
{
    private readonly IApplicationDbContext _context;

    public GetPublicBlogQueryHandler(IApplicationDbContext context)
    {
        _context = context;
    }
    ...
    public async Task<PublicBlogDto?> Handle(GetPublicBlogQuery request, CancellationToken cancellationToken)
    {
