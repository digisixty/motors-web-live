...
public interface IFileStorageService
{
    ...
    /// </summary>
    /// <param name="relativeUrl">The relative URL of the file to delete (e.g., "/bucket-name/path/to/image.jpg")</param>
    /// <param name="cancellationToken">Cancellation token</param>
    /// <returns>True if the file was deleted successfully, false if the file didn't exist</returns>
