...
namespace MyApp.Application.CarListings.Queries.GetCarListingBySlug;

public record GetPublicCarListingBySlugQuery : IRequest<PublicCarListingDto?>
{
    public string Slug { get; init; } = string.Empty;
}

public class GetPublicCarListingBySlugQueryHandler : IRequestHandler<GetPublicCarListingBySlugQuery, PublicCarListingDto?>
{
    private readonly IApplicationDbContext _context;

    public GetPublicCarListingBySlugQueryHandler(IApplicationDbContext context)
    {
        _context = context;
    }

    public async Task<PublicCarListingDto?> Handle(GetPublicCarListingBySlugQuery request, CancellationToken cancellationToken)
    {
