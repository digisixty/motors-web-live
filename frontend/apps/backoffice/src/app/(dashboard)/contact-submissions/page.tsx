...
export default function ContactSubmissionsPage() {
  ...
  const deleteSubmissionMutation = useDeleteContactSubmission({
    mutation: {
      ...
      onError: (error) => {
        toast.error("Failed to delete contact submission: " + error.message);
      },
    },
  });
        ...
        <Card>
          <CardContent className="p-6">
            <div className="text-center text-red-600">
              Error loading contact submissions: {error.message}
            </div>
          </CardContent>
        </Card>
      </div>
    ...
    <div className="container mx-auto py-8 space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            A list of all contact form submissions from customers.
          </CardDescription>
        </CardHeader>
        <CardContent>
          {/* Search Form */}
